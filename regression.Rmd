...
candidate_model_3<- lm(w_pointswon ~ w_n_winners + w_n_ue  + l_n_ue + w_gameswon + tournament + Tour, tennis_train)
...
ggcoef(all_model, 
       ...
       vline_color = "red") + 
  theme_bw()
np_tournament_model <- lm(w_pointswon ~ w_n_winners + Tour + w_n_ue + l_n_ue + w_gameswon,
                          data = tennis_data_linear)
